...
function Message() {
  ...
  return (
    <div className='transition delay-200 ease-initial'>
      <div className='flex flex-col justify-center items-center gap-5 max-[770px]:min-h-100 my-10'>
        ...
        <p className='text-md md:text-lg text-center'>{t("body")}</p>
        <Button>
          <Link href='/' className='text-md md:text-lg font-bold'>{t("buttonMessage")}</Link>
        </Button>
      </div>
    </div>
  )
        ...
        <NextIntlClientProvider>
          ...
          >
            <div className='min-h-screen flex flex-col justify-between bg-inner-background'>
              ...
              <div className='flex items-center justify-center px-5 sm:px-20 py-10 bg-inner-background flex-grow'>
                <Message />
              </div>
